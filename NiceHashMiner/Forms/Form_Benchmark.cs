...
namespace NiceHashMiner.Forms
{
    public partial class Form_Benchmark : Form, IListItemCheckColorSetter, IBenchmarkForm, IBenchmarkCalculation
    {
            ...
            bool autostart = false)
        {
            ...
            devicesListViewEnableControl1.SetComputeDevices(Available.Devices);
            ...
            {
                var firstComputedevice = Available.Devices[0];
        ...
        private void CopyBenchmarks()
        {
            ...
            foreach (var cDev in Available.Devices)
                ...
                {
                    var copyCdevSettings = Available.GetDeviceWithUuid(cDev.BenchmarkCopyUuid);
        ...
        private bool StartButonClick()
        {
            ...
            {
                var noneSelected = Available.Devices.All(cDev => !cDev.Enabled);
                if (noneSelected)
                {
        ...
        private void DevicesListView1_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            ...
            var selectedComputeDevice =
                Available.GetCurrentlySelectedComputeDevice(e.ItemIndex, true);
